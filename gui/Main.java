...
public class Main {
    public static void main(String[] args) {
        ...
        Game g = new Game();
        TitleGUI titleG = new TitleGUI();
        //RandomizerGUI randomG;
        TitleController c = new TitleController(titleG);

        //Ok so i put the gameboard screen kaagad dito cus i dont want to go through the whole random process just to
        //open the gameboard screen lel
        //Gameboard gb = new Gameboard();
        //BoardGUI bg = new BoardGUI();
        
        //Player p = new Player(1);
        //BoardController bc = new BoardController(1, true, gb, p, bg);
